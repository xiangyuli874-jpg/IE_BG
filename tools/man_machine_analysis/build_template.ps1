...
$expectedResult = 'Test_ChineseSourceRoundTrip PASS; Test_DomainConstants PASS; Test_DomainTypes PASS; Test_BaselineFixtureExpansion PASS; Test_WorkbookStructure PASS; Test_WorkbookReaders PASS; Test_ValidationRejectsBadInputs PASS; Test_ValidationReviewFindings PASS'
$MAX_PEOPLE = 5
$MAX_DEVICES = 10
